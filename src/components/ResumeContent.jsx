  ...
  return (
    <div className="p-10 bg-gray-900 text-white min-h-screen overflow-y-auto">
        ...
        <ul className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
          {[
            ...
            <li
              ...
              className="bg-gray-800 p-4 rounded-lg shadow-md hover:shadow-purple-500/20 transition"
            >
              {skill}
            </li>
          ))}
      ...
      <section>
        ...
        <ul className="space-y-6 relative border-l-2 border-purple-500/30 pl-6">
          {[
            ...
            <li
              ...
              className="relative bg-gray-800 p-5 rounded-lg shadow-md hover:shadow-purple-500/20 transition"
            >
              {/* Timeline Dot */}
              <span className="absolute -left-3 top-5 w-4 h-4 bg-purple-500 rounded-full shadow"></span>
              {course}
            </li>
          ))}
        </ul>
